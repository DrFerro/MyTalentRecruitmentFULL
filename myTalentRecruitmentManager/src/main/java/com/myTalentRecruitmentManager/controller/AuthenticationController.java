...
import com.myTalentRecruitmentManager.auth.JwtTokenUtil;
import com.myTalentRecruitmentManager.model.AuthToken;
...
public class AuthenticationController {
    ...
    public ResponseEntity<?> register(@RequestBody LoginUserModel loginUser) throws AuthenticationException {
